      ...
      <div className="signupCard">
          ...
          {/* <CardActionArea> */}
            <CardContent>
              ...
              <Alert severity="error" margin="dense" size="small" >This is an error alert — check it out!</Alert>
              ...
              <Button variant="outlined" color="secondary" fullWidth={true} margin="dense" component="label">
